...
export const features: FeatureItem[] = [
  {
    icon: React.createElement(FiLayout, { className: "w-8 h-8" }), // Fixed icon rendering
  ...
  {
    icon: React.createElement(FiUploadCloud, { className: "w-8 h-8" }),
  ...
  {
    icon: React.createElement(FiBarChart, { className: "w-8 h-8" }),
  ...
  {
    icon: React.createElement(FiServer, { className: "w-8 h-8" }),
...
// design section data
export const tabsData: DesignTab[] = [
  {
    id: "tab1",
...
export const socialLinks: SocialLink[] = [
  { icon: React.createElement(FaFacebook), href: "https://facebook.com" },
  { icon: React.createElement(FaTwitter), href: "https://twitter.com" },
  { icon: React.createElement(FaInstagram), href: "https://instagram.com" },
  { icon: React.createElement(FaLinkedin), href: "https://linkedin.com" },
  { icon: React.createElement(FaYoutube), href: "https://youtube.com" },
];
